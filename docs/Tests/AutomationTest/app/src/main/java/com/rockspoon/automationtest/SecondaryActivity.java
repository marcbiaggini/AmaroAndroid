...
import com.rockspoon.automationtest.Utils.DividerItemDecoration;
...
@EActivity(R.layout.activity_secondary)
public class SecondaryActivity extends AppCompatActivity {
  @Extra("input")
  String extraInput;
  @ViewById(R.id.secondaryActivityTextView)
  TextView viewById;
