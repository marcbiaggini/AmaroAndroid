package com.rockspoon.automationtest.Utils.HandlerEvents;
...
public class Countdown {
  ...
  private static final long COUNTDOWN_TIME_MS = 5000L;
  ...
  private CancellableRunnable makeRunnable() {
    return new CancellableRunnable() {
      ...
      public void run() {
        ...
        long iterations = COUNTDOWN_TIME_MS / UPDATE_INTERVAL_MS;
        for (int i = 0; i < iterations; i++) {
          notifyUpdate(COUNTDOWN_UPDATED, (int) (COUNTDOWN_TIME_MS - i * UPDATE_INTERVAL_MS));
